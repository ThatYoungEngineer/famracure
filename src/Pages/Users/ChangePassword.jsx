        ...
        <div className=" w-[75%]  ">
          <div className="ml-7 ">
            <form className=" w-[55%] ">
              ...
              <button type="button" className="inline-flex items-center px-3 py-2 text-[12px]  text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 ">
                Save Changes
              </button>
            </form>
          </div>
